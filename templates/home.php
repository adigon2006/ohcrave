    ...
    <div class="timeline-block"> -->
                    <div class="panel panel-default share">
                        ...
                        <div class="panel-body">
                            <textarea style="resize: none;" name="myplan" id="myplan" class="form-control share-plan" rows="1" placeholder="Share your next activity with friends..."></textarea>
                        </div>
                        <div class="panel-footer share-buttons">
                            ...
                            <button type="submit" id="postplan" class="btn btn-primary btn-xs pull-right" href="#">Post Event</button>
                        </div>
                  <!--   </div>
                </div> -->
    </div>
      ...
      <!-- <div class="panel panel-default" style="min-height:150px;">
       ...
       <!--Friends -->
                  <?php include_once '../privateprofilefollowers/mylatestfollowers.php'; ?>
                     <div class="panel panel-default hidden-xs hidden-md hidden-sm">
                        <div class="panel-heading panel-heading-gray">
