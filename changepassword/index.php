<?php include_once '../includes/changepassword.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <?php include_once '../meta/meta.php'; ?>
    <title>OHCrave Private Profile</title>
   ...
   ?>
        ...
        <div class="container-fluid">
           <!-- <div class="panel panel-default">
            ...
            <?php include_once '../templates/changepassword.php'; ?>
        </div>
...
<!-- Vendor Scripts Bundle --><script src="../js/vendor.min.js"></script>
    ...
    <script src="../myscript/changepassword.js">
    </script>
